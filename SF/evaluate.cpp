...
*/
 // using namespace Trace;
  ...
  Score evaluate_pieces(const Position& pos, EvalInfo& ei, Score* mobility,
    ...
    return score - evaluate_pieces<Them, NextPt>(pos, ei, mobility, mobilityArea);
  }

  template<>
  Score evaluate_pieces<WHITE, KING>(const Position&, EvalInfo&, Score*, const Bitboard*) { return SCORE_ZERO; }
...
Value Eval::evaluate(const Position& pos) {
  ...
  score +=  evaluate_king<WHITE>(pos, ei)
